<div class="photo">
<ul class="topic">
	<li class="active"><a class="set" href="#">Profile images</a> 
		<ul id="images"> 
		@foreach(File::allFiles('images/profile/pid5/') as $img)
			<li class="slika"><a href="#"><img src="{{$img}}" alt="" title="" /></a></li>
		@endforeach
		</ul>
	</li>
	<li><a class="set" href="#">Upload new photo</a>
		<ul>
			<li id="upload"><?php
